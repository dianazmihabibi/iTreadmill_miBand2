...
$vTcl(tab)$vTcl(tab)$vTcl(tab)methods = Pack.__dict__.keys() | Grid.__dict__.keys() \\
$vTcl(tab)$vTcl(tab)$vTcl(tab)$vTcl(tab)  | Place.__dict__.keys()
...
$vTcl(tab)$vTcl(tab)Text.__init__(self, master, **kw)
...
$vTcl(tab)@_create_container
$vTcl(tab)def __init__(self, master, **kw):
$vTcl(tab)$vTcl(tab)Listbox.__init__(self, master, **kw)
$vTcl(tab)$vTcl(tab)AutoScroll.__init__(self, master)"
    }
...
$vTcl(tab)@_create_container
$vTcl(tab)def __init__(self, master, **kw):
$vTcl(tab)$vTcl(tab)Entry.__init__(self, master, **kw)
$vTcl(tab)$vTcl(tab)AutoScroll.__init__(self, master)"
    }
...
proc vTcl:search_console {prefix} {
    ...
    if {$index != ""} {
        ...
        $source_window tag configure highlight -background wheat
    } ;# end if
}
...
# -----------------
    ...
    button $top.butframe.but36 \
        -text Search \
        -command "vTcl:search_console $prefix" \
        -background $vTcl(pr,bgcolor) -foreground $vTcl(pr,fgcolor)
# ------------------
...
-anchor se
    ...
    if {$prefix == "gui"} {
        ...
        bind $top.butframe.ent14 <Return> {vTcl:search_console "gui"}
    } else {
        bind $base <Configure> {
        ...
        bind $top.butframe.ent14 <Return> {vTcl:search_console "supp"}
    }
...
$vTcl(tab)$vTcl(tab) PhotoImage(\"img_close\", data='''R0lGODlhDAAMAIQUADIyMjc3Nzk5OT09PT
...
$vTcl(tab)$vTcl(tab) PhotoImage(\"img_closeactive\", data='''R0lGODlhDAAMAIQcALwuEtIzFL46
...
$vTcl(tab)$vTcl(tab) PhotoImage(\"img_closepressed\", data='''R0lGODlhDAAMAIQeAJ8nD64qELE
...
$vTcl(tab)$vTcl(tab)PNOTEBOOK = \"ClosetabNotebook\" \n\n"
       ...
       "$vTcl(tab2)$vTcl(tab)('selected', _compcolor)\])\n"
            ...
            foreach p  $pages {
                ...
                append vTcl(py_initfunc) \
                "$vTcl(tab2)self.$sub_name = Frame(self.$widname)\n"
                append vTcl(py_initfunc) \
                "$vTcl(tab2)self.$widname.add(self.$sub_name, padding=3)\n"
        ...
        TNotebook {
            ...
            foreach p  $pages {
                ...
                if {$vTcl(encoding) != ""} {
                    append vTcl(py_initfunc) \
"$vTcl(tab2)self.img$vTcl(notebook_image_count) = PhotoImage(file='''$vTcl(encoding)''')\n"
