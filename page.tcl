...
proc vTclWindow.vTcl {args} {
    ...
    $vTcl(gui,rc_menu) add command -label "Unlock Widget" -command {
        vTcl:unlock_widget   ;# Added August 2018
...
#trace add variable vTcl(w,manager) \
        write "tracer vTcl(w,managet)"
...
#trace add variable vTcl(m,place,-relx) \
    write "tracer vTcl(m,place,-relx)"
